...
| I6 | ntfy push notifications: configurable ntfy server URL, token, and topic in the settings UI; send notification on scan complete, scan error, and batch tag events | 3 | 2 | — |
